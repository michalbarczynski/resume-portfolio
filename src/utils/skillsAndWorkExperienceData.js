export const SKILLS = [
  {
    title: "Frontend",
    icon: "./assets/images/icons8-code-96.png",
    skills: [
      ...
      {
        skill: "OOP with REST API and AJAX",
  ...
  },
  {
    ...
    icon: "./assets/images/icons8-tools-96.png",
    skills: [
  ...
  {
    title: "Tools",
    icon: "./assets/images/icons8-backend-development-96.png",
    skills: [
  ...
  {
    title: "Soft skills",
    icon: "./assets/images/icons8-learning-96.png",
    skills: [
      ...
      {
        skill:
          "Comunicativeness, eesy adaptation to work environment, and work in team",
      },
